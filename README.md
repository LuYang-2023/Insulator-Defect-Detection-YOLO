This code originates from a paper currently being submitted to the ***Remote Sensing*** journal, with the manuscript number ***remotesensing-3032313***. Upon publication, the code will be made publicly available. 
